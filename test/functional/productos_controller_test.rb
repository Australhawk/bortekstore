...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { description: @producto.description, foto: @producto.foto, name: @producto.name, precio: @producto.precio, stock: @producto.stock }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { description: @producto.description, foto: @producto.foto, name: @producto.name, precio: @producto.precio, stock: @producto.stock }
    assert_redirected_to producto_path(assigns(:producto))
  end
